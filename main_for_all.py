...
if __name__ == '__main__':
    ...
    # print('\nQuestion 3')
    #
    # df_prot, gc_percent = a_func.calculate_gc_percentage_in_genes(part_a, df_proteins)
    #
    ...
    #                         histogram_value=list(df_prot[0].loc[:, 'gene gc%']),
    ...
    #
    # print('\nQuestion 4')
    # data_file_errors = a_func.consistent_checks_data_file()
    # print(f'Data file errors: {data_file_errors}')
    #
    # a_func.create_csv_file(columns=['Gene name', 'Start position', 'End position', 'Strand', 'Error'],
